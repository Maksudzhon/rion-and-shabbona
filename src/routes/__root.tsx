...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shabbona va Rion" },
      { name: "description", content: "Ikki qalbning sevgi hikoyasi." },
      { name: "author", content: "Shabbona va Rion" },
      { property: "og:title", content: "Shabbona va Rion" },
      { property: "og:description", content: "Ikki qalbning sevgi hikoyasi." },
